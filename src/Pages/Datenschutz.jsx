  ...
  return (
    <Box sx={{ mt: 4, mb: 4, width: "full" }}>
      ...
      <Typography variant="body1" paragraph>
        ...
        Artikel 13 der Datenschutz-Grundverordnung (DSGVO) auf der Website des
        Waldlabors Oberrhein ADAPT-Wald-Holz informieren. Falls darüber hinaus
        Fragen offen bleiben, kontaktieren Sie uns bitte{" "}
      ...
      <Box mt={2} mb={2}>
        <Typography variant="body1" paragraph>
          <strong>
            Welche Daten von Nutzer:innen speichern die Mediengenossen über
            diese Website?
          </strong>
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          ...
          Ihre Angaben bei uns gespeichert, damit auf diese zur Bearbeitung und
          Beantwortung Ihrer Anfrage zurückgegriffen werden kann. Ohne Ihre
          Einwilligung werden diese Daten nicht an Dritte weitergegeben. Ihre
          Daten werden nur zur Beantwortung Ihrer Anfrage verarbeitet und
      ...
      <Box mt={2} mb={2}>
        ...
        <Typography variant="body1" paragraph>
          Bei Nutzungsdaten handelt es sich um Informationen, die grundsätzlich
          anonym erhoben und für die Entwicklung der Website genutzt werden.
          Wenn Sie unsere Website besuchen, werden auf unserem Webserver
          temporär sogenannte Nutzungsdaten zu statistischen Zwecken als
          Protokoll gespeichert – jedoch nur in anonymisierter Form. Die Daten
          helfen uns dabei, die Qualität unserer Website und Webdienste zu
          verbessern oder Angriffe auf unsere webbasierten Angebote lokalisieren
          zu können.
        </Typography>
        <Typography variant="body1" paragraph>
      ...
      <Box mt={2} mb={2}>
        ...
        <Typography variant="body1" paragraph>
          ...
          als Nutzer:in bestimmte Rechte, über die wir Sie an dieser Stelle
          aufklären.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          ...
          zutrifft, zum Beispiel, wenn die Daten für die verfolgten Zwecke nicht
        ...
        <Typography variant="body1" paragraph>
          ...
          Einschränkung der Verarbeitung zu verlangen, wenn eine der in Art. 18
          DSGVO aufgeführten Voraussetzungen gegeben ist, zum Beispiel, wenn Sie
